...
<div>
    <div class="space-y-4">
        <form action="{{route('msi_update.insaf')}}" method="post" class="space-y-4">
            <div class="p-6 rounded-lg bg-white w-full h-auto space-y-3">
                    @csrf
                    <input type="hidden" name="id" class="readonly form-control" id="" value="{{$data_msi['id']}}">
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="no_jurnal" class="readonly form-control" id="" value="{{$data_msi['no_jurnal']}}"
                                    autocomplete="off" >
                            </div>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="date" name="valid_from" class="active form-control" id="" autocomplete="off"
                                    value="{{ \Carbon\carbon::parse(strtotime($data_msi["valid_from"]))->setTimezone('Asia/Jakarta')->translatedFormat('Y-m-d') }}" >
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="date" name="valid_to" class="active form-control" id="" autocomplete="off"
                                    value="{{ \Carbon\carbon::parse(strtotime($data_msi["valid_to"]))->setTimezone('Asia/Jakarta')->translatedFormat('Y-m-d') }}" >
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <textarea name="information" class="form-control active" id="" cols="30" rows="4">{{$data_msi['information']}}</textarea>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="flex item-center justify-between py-5" x-data="{ open: false }">
                        <div class="flex flex space-x-6 my-1 form-group-1">
                            <div class="input-group flex items-center space-x-3">
                                <input type="radio" @click="open=true" onclick="getWeatherMetSensor()" name="sumber_data_cuaca" value="1" id="" {{$data_msi['sumber_data'] == 1 ? 'checked':''}}>
                                <span class="text-xl font-bold ">VTS Met Sensor</span> 
                            </div>
                            <div class="input-group flex items-center space-x-3">
                                <input type="radio" onclick="getWeatherBMKG()" name="sumber_data_cuaca" value="2" id="" {{$data_msi['sumber_data'] == 2 ? 'checked':''}}>
                                <span class="text-xl font-bold ">BMKG</span> 
                            </div>
                            <div class="input-group flex items-center space-x-3">
                                <input type="radio" onclick="manualFeedWeather()" name="sumber_data_cuaca" value="3" id="" {{$data_msi['sumber_data'] == 3 ? 'checked':''}}>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="wind_speed_min" class="form-control active" value="{{$data_msi['wind_speed_min']}}">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="wind_speed_max" class="form-control active" value="{{$data_msi['wind_speed_max']}}">
                                <span class="modal-open focus:outline-none input-append">
                                    <span class="font-bold">m/s</span>                       
                                </span>
                            </div>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="wind_from" class="form-control active" value="{{$data_msi['wind_from']}}">
                                {{-- <span class="modal-open focus:outline-none input-append">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="wind_to" class="form-control active" value="{{$data_msi['wind_to']}}">
                                {{-- <span class="modal-open focus:outline-none input-append">
                                    <span class="font-bold">%</span>                       
                                </span> --}}
                            </div>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="humidity_min" class="form-control active" value="{{$data_msi['humidity_min']}}">
                                <span class="modal-open focus:outline-none input-append">
                                    <span class="font-bold">%</span>                       
                                </span>
                            </div>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="humidity_max" class="form-control active" value="{{$data_msi['humidity_max']}}">
                                <span class="modal-open focus:outline-none input-append">
                                    <span class="font-bold">%</span>                       
                                </span>
                            </div>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="air_pressure" class="form-control active" value="{{$data_msi['air_pressure']}}">
                                <span class="modal-open focus:outline-none input-append">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="hidden" name="low_tide" class="form-control active" value="{{$data_msi['low_tide']}}">
                                <input type="hidden" name="high_tide" class="form-control active" value="{{$data_msi['high_tide']}}">
                                <input type="hidden" name="low_tide_time" class="form-control active" value="{{$data_msi['low_tide_time']}}">
                                <input type="hidden" name="high_tide_time" class="form-control active" value="{{$data_msi['high_tide_time']}}">
                                <input type="text" name="tide" class="form-control active" value="{{$data_msi['low_tide'].' - '.$data_msi['high_tide']}}">
                                <span class="modal-open focus:outline-none input-append">
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="temperature_min" class="form-control active" value="{{$data_msi['temperature_min']}}">
                                <span class="modal-open focus:outline-none input-append">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="temperature_max" class="form-control active" value="{{$data_msi['temperature_max']}}">
                                <span class="modal-open focus:outline-none input-append">
                                    <span class="font-bold">&deg;C</span>                       
                                </span>
                            </div>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="weather" class="form-control active" value="{{$data_msi['weather']}}">
                                {{-- <span class="modal-open focus:outline-none input-append">
                                    <span class="font-bold">&deg;C</span>                       
                                </span> --}}
                            </div>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <textarea name="additional_info" class="form-control active" id="" cols="30" rows="4" >{{$data_msi['additional_info']}}</textarea>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="my-2">
                        ...
                        <table class="table table-auto my-3">
                            ...
                            <tbody id="appendRowShip" class="">
                                @foreach ($data_old_ship as $item)
                                <tr id="old_row_mmsi{{$item['mmsi']}}">
                                    <td><input type="hidden" name="old_ship_mmsi[]" value="{{$item['mmsi']}}">{{$item['mmsi']}}</td>
                                    <td>{{$item['ship_type']}}</td>
                                    <td>{{$item['gt']}}</td>
                                    <td>{{$item['call_sign']}}</td>
                                    <td class="flex items-center justify-center">
                                        <button type="button" id="{{$item['mmsi']}}" data-msiid="{{$item['msi_id']}}" data-msidetailid="{{$item['id']}}" onclick="deleteOldRowShip(this)"  class="focus:outline-none cta-delete-table">
...
<script>
    function getWeatherMetSensor() {
        $("input[name=valid_from][type=date]").val('');
        $("input[name=valid_to][type=date]").val('');
    ...
    function getWeatherBMKG() {
        ...
        $.getJSON(url, function (data) {
            var f = new Date(data['valid_from'])
            var t = new Date(data['valid_to'])
            var month_from = f.getMonth() < 10 ? '0'+f.getMonth() : ''+f.getMonth();
            var month_to = t.getMonth() < 10 ? '0'+t.getMonth() : ''+t.getMonth();
            var date_from = f.getFullYear()+'-'+ month_from +'-'+f.getDate()
            var date_to = t.getFullYear()+'-'+ month_to +'-'+t.getDate()
            var information = nbsp(stripTags(data['weather_desc']+ ' ' +data['warning_desc']));


            $("input[name=valid_from][type=date]").val(date_from);
            $("input[name=valid_to][type=date]").val(date_to);
    ...
    function getKapal() {
        ...
        $(total_get_mmsi_kapal).each(function () { 
            ...
            // ship_type = this.data
             $('#appendRowShip').append('<tr class="bg-green-100" id="row_mmsi'+this.value+'">'
    ...
    function deleteOldRowShip(data) {
        var mmsi = data.id;
        var msiid = data.getAttribute('data-msiid');
        var msidetailid = data.getAttribute('data-msidetailid');
        console.log(msiid);
        console.log(msidetailid);
        // return false
        var url = '/admin/msi/delete_detail_msi_mmsi/'+msidetailid;
        $.ajax({
            url: url,
            method: "GET",
            dataType: "json",
            success: function (response) {
                $('#appendInfodelete').html('<span class="px-3 py-2 bg-green-400 text-gray-900 rounded-md">Detail Kapal MSI Berhasil Dihapus</span>');
                setInterval('clearnotif()', 5000);
                $('#old_row_mmsi'+mmsi).remove();
            },
            error: function(){
                console.log('failed')
            }
