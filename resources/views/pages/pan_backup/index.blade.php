                            ...
                            <td class="w-40 ">
                                <div class="flex items-center justify-center space-x-2 text-center">
									...
									<div x-data="{ open: false }">
										...
										<div x-show="open" @click.away="open = false"  x-init="setTimeout(() => show = false, 8000)" x-transition:enter="transition duration-200 transform ease-out" x-transition:enter-start="scale-75" x-transition:leave="transition duration-100 transform ease-in" x-transition:leave-end="opacity-0 scale-90" class=" overlay-modal fixed flex items-center justify-center z-50 w-screen h-screen bg-gray-900 bg-opacity-10 flex inset-0">
											<div class="modal relative bg-white overflow-hidden rounded-xl w-96 h-96 z-50">
												<div class="p-5 flex flex-col items-center justify-center modal-body">
													...
													<p class="text-base text-center font-medium text-gray-800"> Yakin ingin hapus PAN "{{ $data["no_jurnal"] }}?</p>
