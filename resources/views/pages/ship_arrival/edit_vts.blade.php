@extends('layouts.main', ['title' => $vts['no_jurnal'] .' | VTS - Edit Ship Arrival - INSAF'])
...
@section('content')
<div class="flex mb-6">
    <h1 class="text-2xl font-bold">(VTS) Edit Ship Arrival | {{$vts['no_jurnal']}}</h1>
</div>
    ...
    <div class="w-full pt-4">
        <form action="{{route('ship_arrival_update.insaf')}}" method="POST">
            ...
            <div x-show="openTab === 1" class="space-y-3">
                {{-- content 1--}}
                <input type="hidden" name="id" class="readonly form-control" id="" value="{{$vts['id']}}" autocomplete="off" readonly>
                {{-- {{$vts['status_bernavigasi']}} <br>
                {{$vts['pintu_kedatangan']}} --}}
                <div class="p-6 rounded-lg bg-white w-full h-auto space-y-3">
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="no_jurnal" class="readonly form-control" id="" value="{{$vts['no_jurnal']}}"
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="datetime-local" name="tanggal" class="readonly form-control" id="" autocomplete="off"
                                    value="{{ \Carbon\carbon::parse(strtotime($vts["tanggal"]))->setTimezone('Asia/Jakarta')->translatedFormat('Y-m-d\TH:i:s') }}" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <select name="jenis_pelayaran" id="jenis_pelayaran" class="active form-control">
                                    ...
                                    @foreach ($jenis_pelayaran as $row)
                                        <option {{$row['id'] == $vts['jenis_pelayaran'] ? 'selected':''}} value="{{$row['id']}}">{{$row['value']}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <select name="agen" id="" class="active form-control">
                                    ...
                                    @foreach ($agen_kapal as $row)
                                        <option  {{$row['id'] == $vts['agen'] ? 'selected':''}}  value="{{$row['id']}}">{{$row['value']}}</option>
                                    @endforeach
                                </select>
                                <span class="input-append">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <select name="sumber_informasi" id="pintu_kedatangan" class="active form-control">
                                    ...
                                    @foreach ($sumber_informasi_awal as $row)
                                        <option  {{$row['id'] == $vts['sumber_informasi'] ? 'selected':''}}  value="{{$row['id']}}" selected>{{$row['value']}}</option>
                                    @endforeach
                                </select>
                                <span class="input-append">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <textarea name="keterangan" class="form-control active" id="" cols="30" rows="4"> {{$vts['keterangan']}} </textarea>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                ...
                <div class="p-6 rounded-lg bg-white w-full h-auto space-y-3">
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input value="{{$old_ship['call_sign']}}" type="text" name="call_sign" class="readonly form-control" id="" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input value="{{$old_ship['flag']}}" type="text" name="flag" class="readonly form-control" id="" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input value="{{$old_ship['mmsi']}}" type="text" name="mmsi" class="readonly form-control" id="mmsi_total_tagihan" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input value="{{$old_ship['gt']}}" type="text" name="gt_kapal" class="readonly form-control" id="" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <select name="status_bernavigasi" id="" class="active form-control">
                                    ...
                                    <option {{$row['id'] == $vts['status_bernavigasi'] ? 'selected':''}} value="{{$row['id']}}">{{$row['ais_status_navigation']}}</option>
                                    @endforeach
                                </select>
                                <span class="input-append">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                    ...
                    <div class="flex flex-col space-y-4 w-1/2">
                        <div class="flex flex-col">
                            ...
                            <div class="flex space-x-3">
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" value="{{$vts['degree1']}}" name="degree1" class="active form-control">
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" value="{{$vts['minute1']}}" name="minute1" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                            '
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" name="second1" value="{{$vts['second1']}}" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                           "
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <select name="direction1" id="" class="active form-control">
                                            ...
                                            <option {{$vts['direction1'] == 'W' ? 'selected':''}} value="W">W</option>
                                            <option {{$vts['direction1'] == 'E' ? 'selected':''}} value="E">E</option>
                                        </select>
                                        <span class="input-append">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                                                viewBox="0 0 28.261 16.031">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex space-x-3">
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" value="{{$vts['degree2']}}" name="degree2" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                            &deg;
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" value="{{$vts['minute2']}}" name="minute2" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                            '
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" value="{{$vts['second2']}}" name="second2" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                           ''
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <select name="direction2" id="" class="active form-control">
                                            <option value="" selected disabled>--</option>
                                            <option {{$vts['direction2'] == 'N' ? 'selected':''}} value="N">N</option>
                                            <option {{$vts['direction2'] == 'S' ? 'selected':''}} value="S">S</option>
                                        </select>
                                        <span class="input-append">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                                                viewBox="0 0 28.261 16.031">
                            ...
                            <div class="w-full space-y-3">
                                ...
                                <div class="relative flex justify-center items-center relative input-group-1">
                                    <select name="pelabuhan_asal" id="" class="active form-control">
                                        ...
                                        <option {{$vts['pelabuhan_asal'] == $row['id'] ? 'selected':''}} value="{{$row['id']}}">{{$row['value']}}</option>
                                        @endforeach
                                    </select>
                                    <span class="input-append">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                            ...
                            <div class="w-full space-y-3">
                                ...
                                <div class="relative flex justify-center items-center relative input-group-1">
                                    <select name="pelabuhan_tujuan" id="" class="active form-control">
                                        <option value="" selected disabled>- Pilih Pelabuhan Asal -</option>
                                        @foreach ($pelabuhan as $row)
                                        <option {{$vts['pelabuhan_tujuan'] == $row['id'] ? 'selected':''}} value="{{$row['id']}}">{{$row['value']}}</option>
                                        @endforeach
                                    </select>
                                    <span class="input-append">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex item-center justify-between space-x-12">
                            <div class="flex flex-col my-1 form-group-1">
                                ...
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="datetime-local"  name="eta" value="{{ \Carbon\carbon::parse(strtotime($vts["eta"]))->setTimezone('Asia/Jakarta')->translatedFormat('Y-m-d\TH:i:s') }}" class="active form-control" id="" autocomplete="off" >
                                </div>
                                <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                    Info here !
                                </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" value="{{ $vts["kurs_tengah"]}}" name="kurs_tengah" class="active form-control" id="kurs_tengah" value="0"
                                    autocomplete="off" readonly>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" value="{{ $vts["total_tagihan"]}}" name="total_tagihan" class="active form-control" id="hasil_total_tagihan" value="0"
                                    autocomplete="off" readonly>
                                <span class="input-append font-bold text-xl">
                                    Rupiah
                                </span>
                ...
                <div class="mt-3 bg-white py-5 px-3 rounded-lg flex items-center justify-between">
                    ...
                    <div>
                        <a href="{{route('ship_arrival.insaf')}}" class="py-2 px-4 py-3 px-10 hover:bg-gray-300 rounded-lg w-auto focus:outline-none     text-gray-400 font-bold text-lg">Batal</a>
...
<script>
    ...
    function cekTotalTagihan() {
        ...
        if(mmsi == null || jenis_pelayaran == null || pintu_kedatangan == null)
        {
            alert('Belum ada kapal yang dipilih !, Jenis pelayaran belum dipilih !')
        }
        else
        {
            $.ajax({
