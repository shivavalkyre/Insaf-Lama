...
@section('content')
<div class="flex mb-6">
    <h1 class="text-2xl font-bold">(SROP) Edit Ship Arrival</h1>
</div>

<div x-data="{ openTab: 1 }">
    <div class="w-full pt-4">
        <form action="{{route('ship_arrival_update.insaf')}}" method="POST">
            @csrf
            {{-- step 1 --}}
            <div x-show="openTab === 1" class="space-y-3">
                {{-- content 1--}}
                <div class="p-6 rounded-lg bg-white w-full h-auto space-y-3">
                    <input type="hidden" name="id" class="readonly form-control" id="" value="{{$srop['id']}}"
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="no_jurnal" class="readonly form-control" id="" value="{{$srop['no_jurnal']}}"
                                    autocomplete="off" readonly>
                            </div>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="datetime-local" name="tanggal" class="readonly form-control" id="" autocomplete="off"
                                    value="{{ \Carbon\carbon::parse(strtotime($srop["tanggal"]))->setTimezone('Asia/Jakarta')->translatedFormat('Y-m-d\TH:i:s') }}" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <select name="jenis_pelayaran" id="jenis_pelayaran" class="active form-control">
                                    ...
                                    @foreach ($jenis_pelayaran as $row)
                                        <option {{$row['id'] == $srop['jenis_pelayaran'] ? 'selected':''}} value="{{$row['id']}}">{{$row['value']}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <select name="agen" id="" class="active form-control">
                                    ...
                                    @foreach ($agen_kapal as $row)
                                        <option {{$row['id'] == $srop['agen'] ? 'selected':''}} value="{{$row['id']}}">{{$row['value']}}</option>
                                    @endforeach
                                </select>
                                <span class="input-append">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <select name="sumber_informasi" id="pintu_kedatangan" class="active form-control">
                                    ...
                                    @foreach ($sumber_informasi_awal as $row)
                                        <option {{$row['id'] == $srop['sumber_informasi'] ? 'selected':''}}  value="{{$row['id']}}" selected>{{$row['value']}}</option>
                                    @endforeach
                                </select>
                                <span class="input-append">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <textarea name="keterangan" class="form-control active" id="" cols="30" rows="4">{{$srop['keterangan']}}</textarea>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                ...
                <div class="p-6 rounded-lg bg-white w-full h-auto space-y-3">
                    ...
                    <div class="flex item-center justify-between space-x-0" x-data="{ open: false }">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" value="{{$old_ship['ship_name']}}" name="ship_name" class="form-control readonly" readonly>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" value="{{$old_ship['perusahaan_pelayaran_id']}}" name="perusahaan_pelayaran" class="readonly form-control" id="" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input value="{{$old_ship['imo']}}"  type="text" name="imo" class="readonly form-control" id="" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" value="{{$old_ship['call_sign']}}" name="call_sign" class="readonly form-control" id="" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="flag" value="{{$old_ship['flag']}}" class="readonly form-control" id="" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" value="{{$old_ship['mmsi']}}" name="mmsi" class="readonly form-control" id="mmsi_total_tagihan" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" value="{{$old_ship['gt']}}" name="gt_kapal" class="readonly form-control" id="" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <select name="status_bernavigasi" id="" class="active form-control">
                                    ...
                                    <option {{$row['id'] == $srop['status_bernavigasi'] ? 'selected':''}} value="{{$row['id']}}">{{$row['ais_status_navigation']}}</option>
                                    @endforeach
                                </select>
                                <span class="input-append">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                ...
                <div class="p-6 rounded-lg bg-white w-full h-auto space-y-3">
                    ...
                    <div class="flex flex-col space-y-4 w-1/2">
                        <div class="flex flex-col">
                            ...
                            <div class="flex space-x-3">
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" value="{{$srop['degree1']}}" name="degree1" class="active form-control">
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" value="{{$srop['minute1']}}" name="minute1" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                            '
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" name="second1" value="{{$srop['second1']}}" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                           "
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <select name="direction1" id="" class="active form-control">
                                            ...
                                            <option {{$srop['direction1'] == 'W' ? 'selected':''}} value="W">W</option>
                                            <option {{$srop['direction1'] == 'E' ? 'selected':''}} value="E">E</option>
                                        </select>
                                        <span class="input-append">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                                                viewBox="0 0 28.261 16.031">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex space-x-3">
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" value="{{$srop['degree2']}}" name="degree2" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                            &deg;
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" value="{{$srop['minute2']}}" name="minute2" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                            '
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" value="{{$srop['second2']}}" name="second2" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                           ''
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <select name="direction2" id="" class="active form-control">
                                            <option value="" selected disabled>--</option>
                                            <option {{$srop['direction2'] == 'N' ? 'selected':''}} value="N">N</option>
                                            <option {{$srop['direction2'] == 'S' ? 'selected':''}} value="S">S</option>
                                        </select>
                                        <span class="input-append">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                                                viewBox="0 0 28.261 16.031">
                            ...
                            <div class="w-full space-y-3">
                                ...
                                <div class="relative flex justify-center items-center relative input-group-1">
                                    <select  name="pelabuhan_asal" id="" class="active form-control">
                                        ...
                                        <option  {{$srop['pelabuhan_asal'] == $row['id'] ? 'selected':''}} value="{{$row['id']}}">{{$row['value']}}</option>
                                        @endforeach
                                    </select>
                                    <span class="input-append">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                            ...
                            <div class="w-full space-y-3">
                                ...
                                <div class="relative flex justify-center items-center relative input-group-1">
                                    <select name="pelabuhan_tujuan" id="" class="active form-control">
                                        <option value="" selected disabled>- Pilih Pelabuhan Asal -</option>
                                        @foreach ($pelabuhan as $row)
                                        <option {{$srop['pelabuhan_tujuan'] == $row['id'] ? 'selected':''}} value="{{$row['id']}}">{{$row['value']}}</option>
                                        @endforeach
                                    </select>
                                    <span class="input-append">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="datetime-local" name="eta"  value="{{ \Carbon\carbon::parse(strtotime($srop["eta"]))->setTimezone('Asia/Jakarta')->translatedFormat('Y-m-d\TH:i:s') }}" class="active form-control" id="" autocomplete="off" >
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                ...
                <div class="mt-3 bg-white py-5 px-3 rounded-lg flex items-center justify-between">
                    ...
                    <div>
                        <a href="{{route('ship_arrival.insaf')}}" class="py-2 px-4 bg-transparent py-3 px-10 hover:bg-gray-200 rounded-lg w-auto focus:outline-none focus:ring-4 text-gray-400 font-bold text-lg" @click="openTab = 1">Batal</a>
                ...
                <div class="p-6 rounded-lg bg-white w-full h-auto space-y-3">
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" value="{{ $srop["preamble"]}}" name="preamble" class="readonly form-control" id="hasil_preamble" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <textarea name="isi_berita" class="form-control active" id="isi_berita_kapal" cols="30" rows="4">{{ $srop["berita"]}}</textarea>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[0]->berita_tambahan_1 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_1').val('')" {{$berita_tambahan[0]->berita_tambahan_1 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_1" class="opacity-0 cursor-pointer absolute" x-model="accept">
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[0]->isi_berita_tambahan_1}}" name="isi_berita_tambahan_1" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_1"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[1]->berita_tambahan_2 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_2').val('')" {{$berita_tambahan[1]->berita_tambahan_2 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_2" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[1]->isi_berita_tambahan_2}}" name="isi_berita_tambahan_2" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_2"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[2]->berita_tambahan_3 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_3').val('')" {{$berita_tambahan[2]->berita_tambahan_3 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_3" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[2]->isi_berita_tambahan_3}}" name="isi_berita_tambahan_3" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_3"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[3]->berita_tambahan_4 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_4').val('')" {{$berita_tambahan[3]->berita_tambahan_4 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_4" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[3]->isi_berita_tambahan_4}}" name="isi_berita_tambahan_4" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_4"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[4]->berita_tambahan_5 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_5').val('')" {{$berita_tambahan[4]->berita_tambahan_5 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_5" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[4]->isi_berita_tambahan_5}}" name="isi_berita_tambahan_5" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_5"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[5]->berita_tambahan_6 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_6').val('')" {{$berita_tambahan[5]->berita_tambahan_6 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_6" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[5]->isi_berita_tambahan_6}}" name="isi_berita_tambahan_6" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_6"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[6]->berita_tambahan_7 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_7').val('')" {{$berita_tambahan[6]->berita_tambahan_7 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_7" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[6]->isi_berita_tambahan_7}}" name="isi_berita_tambahan_7" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_7"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[7]->berita_tambahan_8 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_8').val('')" {{$berita_tambahan[7]->berita_tambahan_8 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_8" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[7]->isi_berita_tambahan_8}}" name="isi_berita_tambahan_8" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_8"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[8]->berita_tambahan_9 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_9').val('')" {{$berita_tambahan[8]->berita_tambahan_9 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_9" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[8]->isi_berita_tambahan_9}}" name="isi_berita_tambahan_9" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_9"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[9]->berita_tambahan_10 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_10').val('')" {{$berita_tambahan[9]->berita_tambahan_10 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_10" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[9]->isi_berita_tambahan_10}}" name="isi_berita_tambahan_10" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_10"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[10]->berita_tambahan_11 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_11').val('')" {{$berita_tambahan[10]->berita_tambahan_11 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_11" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[10]->isi_berita_tambahan_11}}" name="isi_berita_tambahan_11" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_11"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[11]->berita_tambahan_12 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_12').val('')" {{$berita_tambahan[11]->berita_tambahan_12 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_12" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[11]->isi_berita_tambahan_12}}" name="isi_berita_tambahan_12" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_12"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[12]->berita_tambahan_13 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_13').val('')" {{$berita_tambahan[12]->berita_tambahan_13 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_13" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[12]->isi_berita_tambahan_13}}" name="isi_berita_tambahan_13" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_13"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[13]->berita_tambahan_14 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_14').val('')" {{$berita_tambahan[13]->berita_tambahan_14 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_14" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[13]->isi_berita_tambahan_14}}" name="isi_berita_tambahan_14" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_14"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[14]->berita_tambahan_15 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_15').val('')" {{$berita_tambahan[14]->berita_tambahan_15 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_15" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[14]->isi_berita_tambahan_15}}" name="isi_berita_tambahan_15" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_15"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[15]->berita_tambahan_16 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_16').val('')" {{$berita_tambahan[15]->berita_tambahan_16 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_16" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[15]->isi_berita_tambahan_16}}" name="isi_berita_tambahan_16" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_16"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center w-full" x-data="{accept: {{$berita_tambahan[16]->berita_tambahan_17 == 1 ? 'true':'false'}}}">
                            <div class="flex items-center w-full lg:w-1/2 space-x-3">
                                <div class="bg-white border-2 cursor-pointer rounded border-yellow-400 w-6 h-6 flex flex-shrink-0 p-0 justify-center items-center mr-2 focus-within:border-yellow-400 ">
                                    <input type="checkbox" onclick="$('#berita_17').val('')" {{$berita_tambahan[16]->berita_tambahan_17 == 1 ? 'checked="checked"':''}}} value="1" name="berita_tambahan_17" class="opacity-0 cursor-pointer absolute" x-model="accept">
                                    <svg class="fill-current hidden w-5 h-5 text-white bg-yellow-400 pointer-events-none" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                                </div>
                            ...
                            <div class="flex flex-col w-full lg:w-1/2 my-1 form-group-1">
                                <div class="flex justify-center items-center relative input-group-1">
                                    <input type="text" value="{{$berita_tambahan[16]->isi_berita_tambahan_17}}" name="isi_berita_tambahan_17" :class="{ 'readonly' : !accept, 'active' : accept}" class="form-control" id="berita_17"
                                        autocomplete="off"  x-bind:disabled="!accept">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="ck" class="readonly  form-control" id="hasil_ck" value="{{ $srop["ck"]}}"
                                    autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" value="{{ $srop["kurs_tengah"]}}" name="kurs_tengah" class="active form-control" id="kurs_tengah" 
                                    autocomplete="off" readonly>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="tagihan_lsc" value="{{ $srop["tagihan_lsc"]}}" class="active form-control" id="tagihan_lsc"
                                    autocomplete="off" readonly>
                                <span class="input-append font-bold text-xl">
                                    Rupiah
                                </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="tagihan_llc" class="active form-control" id="tagihan_llc" value="{{ $srop["tagihan_llc"]}}"
                                    autocomplete="off" readonly>
                                <span class="input-append font-bold text-xl">
                                    Rupiah
                                </span>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="total_tagihan" class="active form-control" readonly id="hasil_total_tagihan" value="{{ $srop["total_tagihan"]}}"
                                    autocomplete="off" >
                                <span class="input-append font-bold text-xl">
                                    Rupiah
                                </span>
