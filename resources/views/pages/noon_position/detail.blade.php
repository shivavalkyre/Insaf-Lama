@extends('layouts.main', ['title' => $data_parent['no_jurnal'] . " | Noon Position - INSAF"])
...
<div class="rounded-lg relative bg-white w-full overflow-hidden h-auto space-y-3">
    <div class="flex items-center py-7 px-12">
        <h1 class="text-3xl font-bold text-yellow-500">SMS Voyager</h1>
    </div>
            ...
            <tbody>
                ...
                <tr class="">
                    <td class="py-4 px-3">
                        ...
                        <br>
                        <span class="text-2xl font-bold mt-2">{!! $data_parent['degree1'] .'&deg; '. $data_parent['minute1'] ."' ". $data_parent['second1'] .'" '. $data_parent['direction1'] !!}</span>
                    </td>
                    <td class="py-4 px-3">
                        <span class="text-lg mb-2 font-bold text-yellow-400">Latitude</span>
                        <br>
                        <span class="text-2xl font-bold mt-2">{!! $data_parent['degree2'] .'&deg; '. $data_parent['minute2'] ."' ". $data_parent['second2'] .'" '. $data_parent['direction2'] !!}</span>
                    </td>
                </tr>
                <tr class="">
                    <td class="py-4 px-3">
                        <span class="text-lg mb-2 font-bold text-yellow-400">Haluan</span> 
                        <br>
                        <span class="text-2xl font-bold mt-2">{{ $data_parent['haluan'] }}</span>
                    </td>
                    <td class="py-4 px-3">
                        <span class="text-lg mb-2 font-bold text-yellow-400">Kecepatan</span>
                        <br>
                        <span class="text-2xl font-bold mt-2">{{ $data_parent['kecepatan'] }} Knot</span>
                    </td>
                </tr>
                <tr class="">
                    <td colspan="2" class="py-4 px-3">
                        <span class="text-lg mb-2 font-bold text-yellow-400">Nama Lokasi Pelaporan Noon Position</span> 
                        <br>
                        <span class="text-2xl font-bold mt-2">
                            {{ $data_parent['nama_lokasi_kejadian'] }}
                        </span>
                    </td>
                </tr>
                <tr class="">
                    ...
                    <td class="py-4 px-3">
                        ...
                        <br>
                        <span class="text-2xl font-bold mt-2">
                            {{ $data_parent['pelabuhan_tujuan'] }}
                        </span>
                    </td>
                </tr>
                <tr class="border-t border-gray-300">
                    <td class="py-4 px-3">
                        <span class="text-lg mb-2 font-bold text-yellow-400">Jumlah Awak Kapal</span> 
                        <br>
                        <span class="text-2xl font-bold mt-2">
                            {{ $data_parent['jumlah_awak'] }}
                        </span>
                    </td>
                    <td class="py-4 px-3">
                        <span class="text-lg mb-2 font-bold text-yellow-400">Penumpang</span> 
                        <br>
                        <span class="text-2xl font-bold mt-2">
                            {{ $data_parent['jumlah_penumpang'] }}
                        </span>
                    </td>
                    <td class="py-4 px-3">
                        <span class="text-lg mb-2 font-bold text-yellow-400">Jenis Muatan</span> 
                        <br>
                        <span class="text-2xl font-bold mt-2">
                            {{ $data_parent['jenis_muatan'] }}
                        </span>
                    </td>
                </tr>
                <tr class="border-t border-gray-300">
                    <td class="py-4 px-3">
                        <span class="text-lg mb-2 font-bold text-yellow-400">Kondisi Awak Kapal</span> 
                        <br>
                        <span class="text-2xl font-bold mt-2">
                            {{ $data_parent['kondisi_awak_kapal'] }}
                        </span>
                    </td>
                    <td class="py-4 px-3">
                        <span class="text-lg mb-2 font-bold text-yellow-400">Kondisi Kapal</span> 
                        <br>
                        <span class="text-2xl font-bold mt-2">
                            {{ $data_parent['kondisi_kapal'] }}
                        </span>
                    </td>
                    <td class="py-4 px-3">
                        <span class="text-lg mb-2 font-bold text-yellow-400">Posisis BBM Kapal</span> 
                        <br>
                        <span class="text-2xl font-bold mt-2">
                            {{ $data_parent['posisi_bbm'] }}
                        </span>
                    </td>
                </tr>
            </tbody>
...
<div class="rounded-lg mt-7 relative bg-white w-full overflow-hidden h-auto space-y-3">
    <div class="flex items-center py-7 px-12">
        <h1 class="text-3xl font-bold text-yellow-500">Informasi Cuaca Dari Kapal</h1>
    </div>
    <div class="flex px-10 pb-10">
        <table class="w-full">
            <tbody class="">
                    ...
                    <td class="py-4 px-3 ">
                        <div class="flex items-center space-x-7">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-2xl font-bold mt-2">{{ $data_parent['kecepatan_angin'] }} m/s</span>
                            </div>
                        </div>
                    </td>
                    <td class="py-4 px-3">
                        <div class="flex items-center space-x-7">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-2xl font-bold mt-2">{{ $data_parent['temperature'] }} &deg;</span>
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td class="py-4 px-3 ">
                        <div class="flex items-center space-x-7">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-2xl font-bold mt-2">{{ $data_parent['arus'] }} N</span>
                            </div>
                        </div>
                    </td>
                    <td class="py-4 px-3">
                        <div class="flex items-center space-x-7">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-2xl font-bold mt-2">{{ $data_parent['kelembaban'] }} %</span>
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td class="py-4 px-3 ">
                        <div class="flex items-center space-x-7">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-2xl font-bold mt-2">{{ $data_parent['curah_hujan'] }}</span>
                            </div>
                        </div>
                    </td>
                    <td class="py-4 px-3">
                        <div class="flex items-center space-x-7">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-2xl font-bold mt-2">{{ $data_parent['arah_angin'] }}</span>
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td class="py-4 px-3 ">
                        <div class="flex items-center space-x-7">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-2xl font-bold mt-2">{{ $data_parent['tinggi_gelombang'] }} Meter</span>
                            </div>
                        </div>
                    </td>
                    <td class="py-4 px-3">
                        <div class="flex items-center space-x-7">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-2xl font-bold mt-2">{{ $data_parent['jarak_pandang'] }} &deg;</span>
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td class="py-4 px-3 ">
                        <div class="flex items-center space-x-7">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-2xl font-bold mt-2">{{ $data_parent['pasang_surut'] }} CM</span>
                            </div>
                        </div>
                    </td>
                    <td class="py-4 px-3">
                        <div class="flex items-center space-x-7">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-2xl font-bold mt-2">{{ $data_parent['tekanan_udara'] }} Knot</span>
                            </div>
                        </div>
                    </td>
                </tr>
...
<div class="rounded-lg w-full overflow-hidden h-auto space-y-3 py-5 mt-4 px-2 bg-">
    <a href="{{route('noon_position.insaf')}}" class="px-10 py-3 rounded-lg font-bold hover:bg-yellow-300 bg-yellow-400 focus:outline-none focus:ring-4 focus:ring-yellow-300">Kembali</a>
</div>
