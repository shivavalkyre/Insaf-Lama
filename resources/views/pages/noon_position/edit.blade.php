@extends('layouts.main', ['title' =>  $data['no_jurnal'] . ' - Noon Position | INSAF'])
...
@section('content')
<div class="flex mb-6">
    <h1 class="text-2xl font-bold">Edit Noon Position {{$data['no_jurnal']}}</h1>
</div>

<div x-data="{ openTab: 1 }">
    <div class="w-full pt-4">
        <form action="{{route('noon_position_update.insaf')}}" method="post">
            @csrf
            {{-- step 1 --}}
            <div x-show="openTab === 1" class="space-y-3">
                {{-- content 1--}}
                <div class="p-6 rounded-lg bg-white w-full h-auto space-y-3">
                    <input type="hidden" name="id" class="readonly form-control" id="" value="{{$data['id']}}">
                    <div class="flex item-center justify-between space-x-12">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="tgl_jurnal" class="readonly form-control" id="" value="{{ \Carbon\carbon::parse(strtotime($data["tanggal"]))->setTimezone('Asia/Jakarta')->translatedFormat('Y-m-d H:i:s') }}"
                                    autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                    ...
                    <div class="flex item-center justify-between" x-data="{ open: false }">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="ship_name" class="form-control readonly" value="{{$kapal_old['ship_name']}}" readonly>
                                            ...
                                            <div class="my-2">
                                                <table id="table-3" class="">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="radio" {{ $kapal_old['mmsi'] == $row['mmsi'] ? 'checked' : '' }} name="mmsi_kapal" value="{{$row['mmsi']}}"> 
                                                            </td>
                                                            <td>{{$row['ship_name']}}</td>
                                                            <td>{{$row['mmsi']}}</td>
                                                            <td>{{$row['imo']}}</td>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="imo" class="readonly form-control" id="" value="{{$kapal_old['imo']}}" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="call_sign" class="readonly form-control" id="" value="{{$kapal_old['call_sign']}}" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="flag" class="readonly form-control" id="" value="{{$kapal_old['flag']}}" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="mmsi" class="readonly form-control" id="" value="{{$kapal_old['mmsi']}}" autocomplete="off" readonly>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <select name="status_nav" id="" class="active form-control">
                                    ...
                                    <option {{$data['status_navigasi'] == $item['id'] ? 'selected':''}} value="{{$item['id']}}">{{$item['ais_status_navigation']}}</option>
                                    @endforeach
                                </select>
                ...
                <div class="p-6 rounded-lg bg-white w-full h-auto space-y-3">
                    ...
                    <div class="flex flex-col space-y-4 w-1/2">
                        <div class="flex flex-col">
                            ...
                            <div class="flex space-x-3">
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" name="degree1" value="{{$data['degree1']}}" class="active form-control">
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" name="minute1" value="{{$data['minute1']}}"  class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                            '
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" name="second1" value="{{$data['second1']}}" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                           "
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <select name="direction1" id="" class="active form-control">
                                            ...
                                            <option {{$data['direction1'] == "W" ? 'selected':''}} value="W">W</option>
                                            <option {{$data['direction1'] == "E" ? 'selected':''}} value="E">E</option>
                                        </select>
                                        <span class="input-append">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                                                viewBox="0 0 28.261 16.031">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex space-x-3">
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" name="degree2"  value="{{$data['degree2']}}"  class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                            &deg;
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" name="minute2" value="{{$data['minute2']}}" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                            '
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <input type="text" name="second2" value="{{$data['second2']}}" class="active form-control">
                                        <span class="input-append font-bold text-2xl">
                                           ''
                                        </span>
                                    </div>
                                ...
                                <div class="flex flex-col my-1 form-group-1">
                                    <div class="relative flex justify-center items-center relative input-group-1">
                                        <select name="direction2" id="" class="active form-control">
                                            <option value="" selected disabled>--</option>
                                            <option {{$data['direction2'] == 'N' ? 'selected':''}} value="N">N</option>
                                            <option {{$data['direction2'] == 'S' ? 'selected':''}} value="S">S</option>
                                        </select>
                                        <span class="input-append">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                                                viewBox="0 0 28.261 16.031">
                    ...
                    <div class="flex item-center space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="haluan" value="{{$data['haluan']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="kecepatan" value="{{$data['kecepatan']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="nama_lokasi_perairan" value="{{$data['nama_lokasi_kejadian']}}" class="active form-control" id="" autocomplete="off" >
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                            ...
                            <div class="w-full space-y-3">
                                ...
                                <div class="relative flex justify-center items-center relative input-group-1">
                                    <select name="pelabuhan_asal" id="" class="active form-control">
                                        ...
                                        <option {{$data['pelabuhan_asal'] == '1' ? 'selected':''}} value="1">Tanjunng Priok</option>
                                    </select>
                                    <span class="input-append">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                                            viewBox="0 0 28.261 16.031">
                            ...
                            <div class="w-full space-y-3">
                                ...
                                <div class="relative flex justify-center items-center relative input-group-1">
                                    <select name="pelabuhan_tujuan" id="" class="active form-control">
                                        ...
                                        <option {{$data['pelabuhan_tujuan'] == '2' ? 'selected' : ''}} value="2">Merak</option>
                                    </select>
                                    <span class="input-append">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28.261" height="16.031"
                                            viewBox="0 0 28.261 16.031">
                    ...
                    <div class="flex item-center space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="jumlah_awak" value="{{$data['jumlah_awak']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="jumlah_penumpang" value="{{$data['jumlah_penumpang']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                                    <span class="font-bold">Orang</span>
                                </span>
                            </div>
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="jenis_muatan" value="{{$data['jenis_muatan']}}" id="" autocomplete="off" class="active form-control">
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="kondisi_awak_kapal" value="{{$data['kondisi_awak_kapal']}}" class="active form-control" id="" autocomplete="off" >
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="kondisi_kapal" value="{{$data['kondisi_kapal']}}" class="active form-control" id="" autocomplete="off" >
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="flex item-center justify-between space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="flex justify-center items-center relative input-group-1">
                                <input type="text" name="posisi_bbm" value="{{$data['posisi_bbm']}}" class="active form-control" id="" autocomplete="off" >
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                ...
                <div class="p-6 rounded-lg bg-white w-full h-auto space-y-3">
                    ...
                    <div class="flex item-center space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="kecepatan_angin" value="{{$data['kecepatan_angin']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="temperature" id="" value="{{$data['temperature']}}" autocomplete="off" class="active form-control">
                                <span class="input-append">
                    ...
                    <div class="flex item-center space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="arus" value="{{$data['arus']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="kelembapan" value="{{$data['kelembaban']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                    ...
                    <div class="flex item-center space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="curah_hujan" value="{{$data['curah_hujan']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="arah_angin" value="{{$data['arah_angin']}}" id="" autocomplete="off" class="active form-control">
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
                    ...
                    <div class="flex item-center space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="tinggi_gelombang" value="{{$data['tinggi_gelombang']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="jarak_penglihatan" value="{{$data['jarak_pandang']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                    ...
                    <div class="flex item-center space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="pasang_surut" value="{{$data['pasang_surut']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                        ...
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <input type="text" name="tekanan_udara" value="{{$data['tekanan_udara']}}" id="" autocomplete="off" class="active form-control">
                                <span class="input-append">
                    ...
                    <div class="flex item-center space-x-12">
                        <div class="flex flex-col my-1 form-group-1">
                            ...
                            <div class="relative flex justify-center items-center relative input-group-1">
                                <textarea rows="4" cols="10" name="remark_keterangan" id="" autocomplete="off" class="active form-control">{{$data['remarks']}}</textarea>
                            </div>
                            <span class="hidden mt-3 pl-2 text-red-600 font-base">
                                Info here !
                            </span>
