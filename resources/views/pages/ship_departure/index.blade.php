...
@section('content')
<div class="flex mb-6">
    <h1 class="text-2xl font-bold">Ship Departure</h1>
</div>
<div class="p-6 rounded-lg bg-white w-full h-auto" x-data="{ open: false }">
    <div class="block space-y-5 lg:space-y-0 lg:flex items-center justify-between mb-5 lg:w-full">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-end">
            <a href="{{route('ship_departure_create.insaf')}}" class="btn-table-add">
    ...
    <div class="overflow-x-auto overflow-y-auto">
        <div class="my-6">
            <table class="table table-auto my-3">
                <thead class="">
                    <tr>
                        <th class="text-left">No Keberangkatan Kapal</th>
                        <th class="text-left">Tanggal/Jam</th>
                        <th class="text-left">Nama Kapal</th>
                        <th class="text-left">Tanggal/Jam Berangkat</th>
                ...
                <tbody class="">
                    @foreach($array as $data)
                        <tr>
                            <td class="">
                                <a href="{{route('ship_departure_detail.insaf', $data['id'])}}">
									{{ $data['no_jurnal'] }}
                                </a>
                            </td>
                            <td class="">
                            ...
                            <td class="">
								<a href="{{route('ship_departure_detail.insaf', $data['id'])}}">
									{{ \Carbon\carbon::parse(strtotime($data["tanggal_berangkat"]))->setTimezone('Asia/Jakarta')->translatedFormat('l, d F Y | H:i') }}
                                </a>
							</td>
                            <!--<td class="w-40 ">
                        ...
                        x-transition:leave-end="opacity-0 scale-90" class=" overlay-modal fixed flex items-center justify-center z-50 w-screen h-screen bg-gray-900 bg-opacity-10 flex inset-0">
                            <div class="modal relative bg-white overflow-hidden rounded-xl w-96 h-96 z-50">
                                ...
                                <div class="p-5 flex flex-col items-center justify-center modal-body">
                                    ...
                                    <h3 class="text-lg font-bold">Hapus Ship Departure</h3>
                                    <p class="text-base font-medium text-gray-800"> Yakin ingin hapus data "Ship Departure 1" ?</p>
