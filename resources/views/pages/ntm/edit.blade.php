@extends('layouts.main', ['title' => $data_parent['no_jurnal'] .' - INSAF'])
...
<div>
    <div class="space-y-4">
        <form action="{{route('ntm_update.insaf')}}" method="post" enctype="multipart/form-data" class="space-y-4">
            @csrf
            <input type="hidden" name="id" class="readonly form-control" value="{{$data_parent['id']}}">
            <div class="p-6 rounded-lg bg-white w-full h-auto space-y-3">
                <div class="flex item-center justify-between space-x-12">
                    ...
                    <div class="flex flex-col my-1 form-group-1">
                        ...
                        <div class="flex justify-center items-center relative input-group-1">
                            <input type="text" name="no_jurnal" class="readonly form-control" id="" value="{{$data_parent['no_jurnal'] ?? ''}}"
                    ...
                    <div class="flex flex-col my-1 form-group-1">
                        ...
                        <div class="flex justify-center items-center relative input-group-1">
                            <input type="text" name="tanggal" class="readonly form-control" id="" autocomplete="off"
                                value="{!!$data_parent['tanggal']!!}" readonly>
                        </div>
                        <span class="hidden mt-3 pl-2 text-red-600 font-base">
                            Info here !
                        </span>
                ...
                <div class="flex item-center justify-between space-x-12">
                    ...
                    <div class="flex flex-col my-1 form-group-1">
                        ...
                        <div class="relative flex justify-center items-center relative input-group-1">
                            <input type="hidden" name="old_dokumen" value="{{$data_parent['dokumen']}}" class="form-control active" readonly>
                        ...
                        <span class=" mt-3 pl-2 text-blue-500 font-base">
                            Dokumen : <a href="#" class="underline font-medium">{{$data_parent['dokumen']}}</a>
                        </span>
                    </div>
                </div>
                ...
                <div class="flex item-center justify-between space-x-12">
                    ...
                    <div class="flex flex-col my-1 form-group-1">
                        ...
                        <div class="flex justify-center items-center relative input-group-1">
                            <textarea name="keterangan" class="form-control active" id="" cols="30" rows="4">{{$data_parent['keterangan']}}</textarea>
                        </div>
                        <span class="hidden mt-3 pl-2 text-red-600 font-base">
                            Info here !
                        </span>
                            ...
                            <tbody id="appendRowShip" class="">
                                ...
                                <tr id="old_row_mmsi{{$item['mmsi']}}">
                                    ...
                                    <td class="flex items-center justify-center">
                                        <button type="button" id="{{$item['mmsi']}}" data-ntmid="{{$item['ntm_id']}}" data-ntmdetailid="{{$item['id']}}" onclick="deleteOldRowShip(this)"  class="focus:outline-none cta-delete-table">
...
<script>
    ...
    function deleteOldRowShip(data) {
        var mmsi = data.id;
        var ntmid = data.getAttribute('data-ntmid');
        var ntmdetailid = data.getAttribute('data-ntmdetailid');
        console.log(ntmid);
        console.log(ntmdetailid);
        // return false
        var url = '/admin/ntm/delete_detail_ntm_mmsi/'+ntmid+'/'+ntmdetailid;
        $.ajax({
            url: url,
            method: "GET",
            // cache: false,
            // data: {mmsi: mmsi, id:ntmid, ntm_detail_id:ntmdetailid},
            dataType: "json",
            success: function (response) {
                $('#appendInfodelete').html('<span class="px-3 py-2 bg-green-400 text-gray-900 rounded-md">Detail Kapal NTM Berhasil Dihapus</span>');
