@extends('layouts.auth', ['title' => 'Reset Password - INSAF'])
...
<div class="w-full h-full rounded card-auth">
    ...
    <div class="w-full h-auto py-2 lg:py-4 block flex flex-col justify-center items-center header">
        ...
        <h1 class="mt-10 text-2xl mb-3 lg:mb-4 lg:text-6xl font-bold">Reset Password ?</h1>
        <p class="text-center">Enter your email address to change your password.</p>
    </div>

    {{-- Forms --}}
    <div class="w-full h-auto px-3 lg:px-28 lg:pb-0 pt-5 lg:pt-2 body">
        <form action="" method="">
            ...
            <div class="flex flex-col mt-5 lg:mt-8 lg:mb-3 form-group">
                <div class="flex justify-center items-center relative input-group">
                    <input type="text" name=""
                        class="w-full py-3 lg:py-6 pr-4 lg:pr-8 pl-14 lg:pl-16 text-sm lg:text-lg font-bold rounded-xl outline-none border-2 active form-control"
                        id="" placeholder="Enter your email" autocomplete="off">
            ...
            <div class="flex flex-col items-center justify-center mb-3 mt-5 lg:mt-8 lg:mb-3  form-group">
                <button type="submit" class=" flex items-center justify-center shadow-xl hover:shadow-none w-full lg:w-56 focus:outline-none focus:ring-4 ring-gray-500 bg-black py-3 lg:py-3 lg:px-10 text-white rounded-lg font-medium text-base lg:text-base hover:bg-gray-800 my-2 lg:my-0">Reset Password</button>

                <a class="mt-8 mb-3 text-gray-700 hover:text-gray-900 hover:font-bold hover:underline" href="{{ route('login.insaf') }}">Back to login</a>
            </div>
